...
public class App 
{
    public static void main( String[] args )
    {
        ...
        System.out.println(Arrays.toString(myString) + " "+i); // at index 2 value will get change but i will be 3

        myString[--i] = "SitaRam";

        System.out.println(Arrays.toString(myString) + " "+i); // at index 2 value will get change but i will be 2
