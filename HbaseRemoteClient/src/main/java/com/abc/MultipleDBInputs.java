...
public class MultipleDBInputs {
    ...
    public static void addInputTable(Job job, HTable htable,
        ...
        System.out.println("com.abc.MultipleDBInputs->addInputTable3");
    ...
    public static void addInputTable(Job job, HTable htable,
        ...
        System.out.println("com.abc.MultipleDBInputs->addInputTable4");
    ...
    static Map<String, Class<? extends InputFormat>> getInputFormatMap(JobContext job) {
        System.out.println("com.abc.MultipleDBInputs->getInputFormatMap");
...
//                        .getClassByName(split[1]), conf);
                ...
                System.out.println("com.abc.MultipleDBInputs->getInputFormatMap "+split[0]+" : "+split[1]);
    ...
    getMapperTypeMap(JobContext job) {
        System.out.println("com.abc.MultipleDBInputs->getMapperTypeMap");
        Configuration conf = job.getConfiguration();
        ...
        for (String pathMapping : pathMappings) {
            ...
            try {
                ...
                System.out.println("com.abc.MultipleDBInputs->getMapperTypeMap "+split[0]+" : "+split[1]);
            } catch (ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
        }
