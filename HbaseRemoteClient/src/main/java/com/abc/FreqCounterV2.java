...
public class FreqCounterV2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.set("hbase.mapreduce.multipleinputtables.mappers","access_logs_1;com.abc.Mapper1,access_logs_2;com.abc.Mapper1");
...
//        job.setMapperClass(com.abc.Mapper1.class);
