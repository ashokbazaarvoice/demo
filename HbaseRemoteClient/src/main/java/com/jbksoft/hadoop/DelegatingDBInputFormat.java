...
public class DelegatingDBInputFormat<K, V>
    ...
    public List<InputSplit> getSplits(JobContext job)
        ...
        System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits");
        ...
        System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits "+mapperMap.size());
        for(Map.Entry<String, Class<? extends Mapper>> mapEntry :
                mapperMap.entrySet()){
            System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits "+mapEntry.getKey() +" : "+mapEntry.getValue());
        }
...
//            }
//            System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits "+entry.getValue().getClass()+" : "+entry.getKey());
...
//                        .size()]));
            ...
            System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits "+formatClass+" : "+pathSplits.size()+" : "+mapperClass+" : "+formatEntry.getKey() + " : "+hTable);
...
//            }
        ...
        System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->getSplits "+splits.size());
        return splits;
    }
    ...
    public RecordReader<K, V> createRecordReader(InputSplit split,
        ...
        System.out.println("com.jbksoft.hadoop.DelegatingDBInputFormat->createRecordReader");
