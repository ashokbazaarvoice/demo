...
import com.jbksoft.hadoop.TaggedDBInputSplit;
...
public class DelegatingDBRecordReader <K, V> extends RecordReader<K, V> {
    ...
    public DelegatingDBRecordReader(InputSplit split, TaskAttemptContext context)
        ...
        System.out.println("com.jbksoft.hadoop.DelegatingDBRecordReader->constructor");
        // Find the InputFormat and then the RecordReader from the
        // TaggedInputSplit.
        TaggedDBInputSplit taggedInputSplit = (TaggedDBInputSplit) split;
        System.out.println("com.jbksoft.hadoop.DelegatingDBRecordReader->constructor"+taggedInputSplit.getInputFormatClass()+" : "+taggedInputSplit
