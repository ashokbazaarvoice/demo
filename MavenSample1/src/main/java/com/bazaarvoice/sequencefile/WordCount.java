package com.bazaarvoice.sequencefile;
...
public class WordCount {
    ...
    public static class SumReduce extends Reducer<Text, LongWritable, Text, LongWritable> {
        ...
        public void reduce(Text key, Iterator<LongWritable> values,
            ...
            System.out.println(key.toString()+"-509 \r ");
            newKey.set(key.toString()+"-509 \r ");
            context.write(newKey, new LongWritable(sum));
