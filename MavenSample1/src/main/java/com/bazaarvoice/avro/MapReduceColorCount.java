...
import com.bazaarvoice.example.avro.User;
...
public class MapReduceColorCount extends Configured implements Tool {
    ...
    public static class ColorCountMapperV2 extends
    ...
    public static class ColorCountReducerV2 extends
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(ColorCountMapperV2.class);
        AvroJob.setInputKeySchema(job, User.getClassSchema());
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(IntWritable.class);

        job.setOutputFormatClass(AvroKeyValueOutputFormat.class);
        job.setReducerClass(ColorCountReducerV2.class);
